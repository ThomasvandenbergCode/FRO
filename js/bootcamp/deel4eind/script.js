...
var part4 = {
    ...
    instruction1: function () {
        ...
        // Create the object
        var student = { name: "Yosef East", group: "MD2", lessons: ["FRO", "BAP", "PROJ"] };

        // Display the properties name, group and first lesson
    ...
    instruction4: function () {
        ...
        // Call the webAPI and make a bullet list of the student names
        var xhttp = new XMLHttpRequest();
        xhttp.onreadystatechange = function () {
            if (this.readyState == 4 && this.status == 200) {
                var result = "<h4>JSON-formaat</h4>";
