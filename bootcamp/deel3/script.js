...
// Declare variables
var student = "thomas van den Berg";
var year = 2018;
var group = "MD2B";
var title = "JavaScript Bootcamp " + year;
var currentYear = (new Date()).getFullYear();
var period = getPeriod(2018, currentYear)
var elementen =   document.getElementById("instructionResult").addEventListener("click", instruction9);
// Init
instruction4();
instruction5();
...
function instruction7c() {
    ...
    return "En tenslotte door gebruik te maken van een array weet ik ook dat het vandaag " +  '<b>' + day + '</b>' + " is.";
}
...
function instruction8() {
    ...
    var colors = [" Rood", " Geel", " Blauw", " Groen", " Zwart", " Oranje", " Bruin", " Paars"];
...
btnRight.addEventListener("click", function () { alert("naar rechts")});
  ...
  //
  //  var btn1 = document.createElement("BUTTONlinks");
  //  var btn2 = document.createElement("BUTTONrechts");
  //  var links = document.createTextNode("links");
  //  var rechts = document.createTextNode("rechts");
  //  btn1.appendChild(links);
  //  btn2.appendChild(rechts);
  // var alarm = document.getElementById("BUTTONlinks").alert("I am an alert box!");
  //  document.getElementById("instructionResult").appendChild(btn1);
  //  document.getElementById("instructionResult").appendChild(btn2);
